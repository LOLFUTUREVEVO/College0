    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/locations/all").permitAll()
                        .requestMatchers("/schools/all").permitAll()
                        .requestMatchers("/teams/frc/all").permitAll()
                        .requestMatchers("/teams/fll/all").permitAll()
                        .requestMatchers("/teams/ftc/all").permitAll()
                        .requestMatchers("/sync/**").permitAll()
                        .requestMatchers("/records/**").permitAll()
                        .requestMatchers("/legacy/records/**").permitAll()
